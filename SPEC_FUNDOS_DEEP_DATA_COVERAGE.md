...
| **S4** | 23-29/05 | **Anexo 14-V FII via CSV** (`inf_trimestral_fii_imovel/inquilino/resultado_contabil`) + **Atas** (de Eventos) + **FIDC Tabs III/VI/IX/X_4/X_5/X_7** (DEFERRED até refactor streaming OU 512MB Edge memory — empirical OOM 27/04 ao adicionar X_4 sozinho que tem 7.7MB descomprimido) + **Cancelamentos** | unchanged — LLM FII removido em V2; tabs FIDC requer refactor |
