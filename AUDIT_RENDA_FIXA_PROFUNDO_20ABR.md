...
> **Status entrega (20/04/2026):** P0 (12 tickets) **🟡 em execução** — audit doc gerado, plano P0/P1/P2 priorizado, implementação iniciada. Deliverable escolhido pelo Lucas: **audit doc + P0 implementado** (mesmo fluxo de Crédito 19/04). Build target: tsc 0 / vite < 6s / HubRendaFixa chunk < 160 kB.

## TL;DR

Auditoria end-to-end (frontend + backend + dados) do módulo `/hub/renda-fixa` (HubRendaFixa.tsx, 925 linhas · 5 narrative sections · 30 indicadores BACEN SGS) encontrou **2 bugs de dados** (meta drift em 7 séries + unit label errado em Selic código 11) e **16 gaps P1/P2** de UX, narrativa e pattern parity com os módulos Crédito e Fundos já auditados. Nenhum bug sintético como o que afetou CreditOperationsPanel — dados RF são todos BACEN SGS diretos.
